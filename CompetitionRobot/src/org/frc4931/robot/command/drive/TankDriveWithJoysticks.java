...
/**
 * Updates CompetitionRobot.driveTrain with the current joystick values using the pitch of joystick 1 for left speed and the pitch
 * of joystick 2 for right speed.
 *
